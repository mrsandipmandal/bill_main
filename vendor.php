		...
		<div class="row">
			...
			<div class="col-md-12">
							...
							<div class="col-md-6">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" value=""  id="pan" name="pan" required class="form-control brd" />
									</div>
								</div>	
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="number" value=""  id="mob" name="mob" pattern= "[0-9]"  maxlength="10"  class="form-control brd" />
									</div>
								</div>	
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" value=""  id="gstin" name="gstin"  class="form-control brd" />
									</div>
								</div>	
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" value=""  id="addr" name="addr"  class="form-control brd" />
									</div>
								</div>	
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" value=""  id="bank_nm" name="bank_nm"  class="form-control brd" />
									</div>
								</div>	
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" value=""  id="bank_bcd" name="bank_bcd"  class="form-control brd" />
									</div>
								</div>	
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" value=""  id="ifsc" name="ifsc"  class="form-control brd" />
									</div>
								</div>	
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" value=""  id="bank_ac" name="bank_ac"  class="form-control brd" />
									</div>
								</div>	
				...
				<div class="box box-success">
					...
					<div class="form-group pull-right">
					<div class="col-md-12">
					<button type="button" class="btn btn-sm btn-success" onclick="vendor_list()">Show</button>
					</div>
					</div>
					</div>
...
$('#show').load("vendor_list.php?ps="+ps+"&pno="+pno+"&bcd="+bcd+"&all="+all).fadeIn('fast');
$('#pgn').val=pno;
}
