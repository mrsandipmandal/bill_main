						...
						<input type="hidden"   value=""  id="sl" name="sl"   />
							...
							<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" value=""  id="brnch"  name="brnch" required class="form-control brd" />
									</div>
								</div>					
								<!-- end col-3 -->
								<div class="col-md-6">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="number" min="0" value="" step="any"  id="pin" name="pin" required class="form-control brd" />
									</div>
								</div>
