...
$limit1="limit ".$start.",".$ps;
		...
		$list1->set_table("main_loading_point","sl");
...
<?php
		...
		{  
			...
			$cust_ccd=$pdo->get_value('main_cust','ccd',array('sl'=>$cid));
	$sln++;      

	?>
	<tr>
		<td  align="left" style="padding-left:25px;">
		<a title="Click to Edit"  style="cursor:pointer" href="loading_point_edt.php?sl=<?php echo $sl;?>"><i class="fa fa-pencil-square-o"></i></a>&nbsp;
