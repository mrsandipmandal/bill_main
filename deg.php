			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<form method="POST" action="degs.php" enctype="multipart/form-data">
						<input type="hidden"   value=""  id="sl" name="sl"   />
							...
							<div class="row">
								<input type="hidden" name="table_name" value="main_deg" class="form-control" />
								<input type="hidden" name="page_name" value="deg.php" class="form-control" />
								<!-- begin col-6 -->
								<div class="col-md-12">
...
$('#show').load("deg_list.php?ps="+ps+"&pno="+pno).fadeIn('fast');
$('#pgn').val=pno;
}
