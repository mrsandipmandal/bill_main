...
<th style="text-align:left">PRIMARY ACCOUNT</font></th>
<th style="text-align:left">ACCOUNT GROUP</font></th>
<th style="text-align:left">LEDGER HEAD</font></th>
<th style="text-align:left">BRANCH NAME</font></th>
</tr>
<?php
		...
		{  
			...
			$pcd_nm=$pdo->get_value('main_primary','nm',array('sl'=>$pcd));
			$gcd_nm=$pdo->get_value('main_group','nm',array('sl'=>$gcd));
	...
	<tr>
		...
		<?php if($stat==1){?>
		<a title="Click to Edit"  style="cursor:pointer" href="ldgr_edt.php?sl=<?php echo $sl;?>"><i class="fa fa-pencil-square-o"></i></a>&nbsp;		
		...
		<td align="left"><?php echo $pcd_nm;?></td>
		<td align="left"><?php echo $gcd_nm;?></td>
