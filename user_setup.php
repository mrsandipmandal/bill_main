							...
							<div class="col-md-6">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" value=""  id="username" name="username" onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode >=65 && event.charCode <= 90 || event.charCode >=97 && event.charCode <= 122' required class="form-control brd" />
									</div>
								</div>		
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" value=""  id="nm" name="nm"  class="form-control brd" />
									</div>
								</div>		
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="number"  pattern= "[0-9]"  maxlength="10" value="" id="mob" name="mob"  class="form-control brd" />
									</div>
								</div>			
								<!-- end col-3 -->
...
$('#show').load("user_list.php?ps="+ps+"&pno="+pno+"&usl="+usl).fadeIn('fast');
$('#pgn').val=pno;
}
